function [xopt, fopt, iter] = ex7_17(func, xlow, xhigh, es, maxit, varargin)
% input
% func: 함수
% xlow: 초기 하한값
% xmiddle: 초기 중간값
...
% 3개 이하 입력시 종료기준 근사오차 0.0001로 초기화
% 4개 이하 입력시 최대 반복횟수 50개 초기화

iter = 0;
x1 = xlow;
x2 = (xlow + xhigh)/2;  % 두번째 초기 가정값은 상한 하한의 중간 값
x3 = xhigh;
f1 = func(x1, varargin{:});
f2 = func(x2, varargin{:});
f3 = func(x3, varargin{:});
